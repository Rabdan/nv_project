  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-900">
    <div class="bg-gray-800 p-8 rounded-xl border border-gray-700 w-full max-w-md">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <button type="submit" :disabled="loading" class="w-full py-2 bg-blue-600 hover:bg-blue-500 rounded font-medium transition-colors disabled:opacity-50 text-white">
